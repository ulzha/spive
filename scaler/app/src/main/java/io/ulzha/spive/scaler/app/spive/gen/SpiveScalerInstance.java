...
public interface SpiveScalerInstance {
  ...
  default void accept(final ScaleProcess event) {}

  default void accept(final ScaleProcess event, final EventTime eventTime) {
    accept(event);
  }
  ...
  class Main extends InstanceMain {
    ...
    public static void main(final Umbilical umbilical, final String... args) throws Exception {
      ...
      try (EventLog inputEventLog = EventLog.open(args[0], args[1]);
        ...
        LOG.info(
            "SpiveScaler instance exiting {}, with {}",
            logExitStatus,
    ...
    private static List<Runnable> selectWorkloads(SpiveScaler app, final String workloads) {
